...
class Water_PurifierQR extends Component{
    ...
    async getItems()
    {   
        let imageRef = storageRef.ref('/Home_Appliances/Water Purifier/QR Code3.jpg');
        imageRef
        .getDownloadURL()
        .then((url) => {
    ...
    render()
    {
      return(
        <View  style={{alignItems:"center",justifyContent:"center"}}>
           <Image source={this.state.imageRef} style={{width:"100%",height:800}} />
           <View style={{alignItems:"center",justifyContent:"center"}}>
  ...
  export default Water_PurifierQR;