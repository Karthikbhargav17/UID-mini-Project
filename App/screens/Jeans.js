...
class Jeans extends Component{
    ...
    async getItems1()
    {   
        let imageRef = storageRef.ref('Clothing/Jeans/jeans1.png');
        imageRef
        .getDownloadURL()
        .then((url) => {
    ...
    async getItems2()
    {   
        let imageRef = storageRef.ref('Clothing/Jeans/jeans2.png');
        imageRef
        .getDownloadURL()
        .then((url) => {
        //from url you can fetched the uploaded image easily
      ...
      return(
        <View  style={{marginTop:50,width:'100%',height:800}}>
            ...
            <View style={{alignItems:"center",justifyContent:"center"}}>
                <TouchableOpacity onPress={()=>{this.props.navigation.navigate("JeansQR")}} style={{marginVertical:10 ,borderRadius:10,backgroundColor: "#00008b",width:150,height:45,alignItems:"center",justifyContent:"center"}}>
